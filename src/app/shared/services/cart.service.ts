...
export class CartService {
  ...
  add(data: any, quantity: number) {
    ...
    // check product pick up at store or not.
    // if (data.product.shop.pickUpAtStore) {
    //   this.toasty.error(this.translate.instant('This product needs to be picked up at store directly after payment'));
    // }
    this.cart.unshift({
